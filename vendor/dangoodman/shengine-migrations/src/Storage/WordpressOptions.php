...
class WordpressOptions implements \TrsVendors\Dgm\Shengine\Migrations\Interfaces\Storage\IStorage
{
    ...
    {
        return new \TrsVendors\Dgm\Shengine\Migrations\Storage\StorageRecord($this, $key, $default);
    }
