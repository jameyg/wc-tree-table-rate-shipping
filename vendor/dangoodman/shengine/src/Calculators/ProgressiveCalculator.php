...
class ProgressiveCalculator implements \TrsVendors\Dgm\Shengine\Interfaces\ICalculator
{
    public function __construct(\TrsVendors\Dgm\Shengine\Interfaces\IAttribute $attribute, \TrsVendors\Dgm\NumberUnit\NumberUnit $attributeUnit, $cost, $step = 0, $skip = 0)
    {
    ...
    public function calculateRatesFor(\TrsVendors\Dgm\Shengine\Interfaces\IPackage $package)
    {
        ...
        return array(new \TrsVendors\Dgm\Shengine\Model\Rate($result));
    }
