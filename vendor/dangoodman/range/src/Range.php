<?php
namespace TrsVendors\Dgm\Range;
 ...
 */
class Range extends \TrsVendors\Dgm\SimpleProperties\SimpleProperties
{
    ...
    public function includes($value, \TrsVendors\Dgm\Comparator\IComparator $comparator)
    {
        return
